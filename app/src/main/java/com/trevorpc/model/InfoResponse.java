...
public class InfoResponse implements Serializable, Parcelable
{
    ...
    public final static Creator<InfoResponse> CREATOR = new Creator<InfoResponse>() {


        @SuppressWarnings({
            "unchecked"
        })
        public InfoResponse createFromParcel(Parcel in) {
            return new InfoResponse(in);
        }
    ...
    ;
    private final static long serialVersionUID = 2331961964520980094L;

    protected InfoResponse(Parcel in) {
     ...
     */
    public InfoResponse(String login, Integer id, String nodeId, String avatarUrl, String gravatarId, String url, String htmlUrl, String followersUrl, String followingUrl, String gistsUrl, String starredUrl, String subscriptionsUrl, String organizationsUrl, String reposUrl, String eventsUrl, String receivedEventsUrl, String type, Boolean siteAdmin, String name, Object company, String blog, String location, Object email, Object hireable, String bio, Integer publicRepos, Integer publicGists, Integer followers, Integer following, String createdAt, String updatedAt) {
        super();
        this.login = login;
        this.id = id;
        this.nodeId = nodeId;
